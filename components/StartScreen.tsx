...
const StartScreen: React.FC<StartScreenProps> = ({
  ...
  return (
    <div className="bg-slate-800 dark:bg-slate-800 shadow-xl rounded-lg p-8 w-full text-center animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 gap-8 text-left">
        ...
        <div
          className={`bg-slate-50 dark:bg-slate-700/50 p-6 rounded-lg border border-slate-200 dark:border-slate-700 flex flex-col transition-opacity ${
            !isUsernameValid || hasCompletedDisc ? "opacity-60" : ""
          }`}
        >
          ...
          <p className="text-slate-600 dark:text-slate-300 mb-4 flex-grow">
            Understand your behavioral style. The DISC model focuses on
          ...
          <button
            ...
            aria-label={
              hasCompletedDisc
                ? "DISC assessment already completed"
        ...
        <div
          className={`bg-slate-50 dark:bg-slate-700/50 p-6 rounded-lg border border-slate-200 dark:border-slate-700 flex flex-col transition-opacity ${
            !isUsernameValid || hasCompletedHerrmann ? "opacity-60" : ""
          }`}
        >
          <h2 className="text-2xl font-bold text-amber-500 dark:text-amber-400 mb-3">
            Herrmann Model
          </h2>
          <p className="text-slate-600 dark:text-slate-300 mb-4 flex-grow">
            Discover your preferred thinking style across four quadrants:
          ...
          <button
            ...
            aria-label={
              hasCompletedHerrmann
                ? "Herrmann assessment already completed"
                : "Start Herrmann Assessment"
            }
          >
